...
// Componente isolado — useGoogleLogin só roda dentro do GoogleOAuthProvider
    ...
    <div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-card px-6 py-12">
        ...
        <div className="w-full max-w-[380px] space-y-6">
          ...
          {/* Botão Google — só renderiza se o provider estiver ativo */}
          {GOOGLE_CLIENT_ID && <GoogleLoginButton disabled={isPending} />}
